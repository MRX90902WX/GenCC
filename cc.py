...
def colombia():
    ...
    data = json.loads(rs.text)
    card = data['creditCard'][1]
    return ("\033[1;32m[-] TIPO : %s\n[-] Numero de Tarjeta : %s\n[-] Banco : %s\n[-] Pais : %s\n[-] CVV : %s\n[-] Expira : %s\n============================\n[*] Grupo WhatsApp : https://chat.whatsapp.com/BQQ9ARePQEJGz99DFz8CN8" % (card['IssuingNetwork'] , card['CardNumber'] , card['Bank'] , card['Country'] , card['CVV'] , card['Expiry']) + cv)
